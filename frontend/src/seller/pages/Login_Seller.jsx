...
export default function Login_Seller() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/auth/login/seller`, {
        method: 'POST',
            ...
            <div className="bg-white shadow-none rounded-none border-0">
              <div className="flex flex-wrap">
                ...
                <div className="w-full lg:w-1/2">
                  <img
                    src="https://demo.activeitzone.com/ecommerce_repo/public/uploads/all/HxuTwjeiDQNpygrBUB2nGKSBJJAe9ioZsRr1xhef.webp"
                    alt="Seller Login Page Image"
                ...
                >
                  ...
                  <div className="text-center lg:text-left">
                    ...
                    <h5 className="text-[14px] font-normal text-[#292933]">Login To Your Seller Account</h5>
                  </div>
                    ...
                    <div>
                      <form className="form-default" onSubmit={handleSubmit}>
                        ...
                        <div className="mb-[1rem]">
                          <label htmlFor="email" className="text-[12px] font-bold block mb-[0.5rem]" style={{ color: '#3f4254' }}>
                            Email
                          </label>
                          <input
                            type="email"
