...
export default function PickupPointOrders_Seller() {
  ...
  const filtered = orders.filter(o => {
    ...
    if (dt === 'home_delivery' || dt === '') return false
      ...
      <div className="text-left pb-[5px]">
        <div className="flex items-center">
          <div className="flex-1">
            <h1 className="text-[20px] font-bold text-[#2E294E]">Pickup Point Orders</h1>
          </div>
        </div>
      </div>
                  ...
                  <div className="absolute top-full left-0 mt-1 bg-white shadow-md border border-[#f1f1f4] rounded-[4px] z-10 w-full py-3">
                    {DELIVERY_OPTIONS.map((label) => (
                      <div key={label} className="hover:bg-[#f5f5f7] py-2 flex items-center px-3">
                        <input type="checkbox" id={`pp-${label}`} className="mr-2"
                        ...
                        <label className="text-[14px] text-[#2E294E]" htmlFor={`pp-${label}`}>{label}</label>
                      </div>
                    ))}
                  </div>
                )}
              ...
              {loading ? (
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {paginated.length === 0 ? (
                      <tr>
                        <td colSpan={10} className="text-center py-10 text-[14px] text-[#a1a5b3]">No pickup point orders found.</td>
                      </tr>
                    ) : (
                      paginated.map((o) => {
