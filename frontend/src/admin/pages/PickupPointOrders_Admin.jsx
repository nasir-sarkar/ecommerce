...
export default function PickupPointOrders_Admin() {
  ...
  // Filter: only orders where deliveryType is NOT home_delivery
  const filtered = orders.filter(o => {
    const dt = (o.deliveryType || '').toLowerCase()
    if (dt === 'home_delivery') return false
  ...
  return (
    <>
      <h1 className="text-[20px] leading-[28px] font-bold text-[#232734] mb-[16px]">Pick-up Point Orders</h1>
      <Card>
