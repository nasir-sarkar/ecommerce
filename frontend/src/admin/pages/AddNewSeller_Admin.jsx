...
export default function AddNewSeller_Admin() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true)
    try {
      const res  = await fetch(`${API}/manage/sellers`, {
        method: 'POST',
  ...
  return (
    <>
      {/* Page title */}
      <h1 className="text-[20px] leading-[28px] font-semibold text-[#232734] mb-[20px]">Add New Seller</h1>
