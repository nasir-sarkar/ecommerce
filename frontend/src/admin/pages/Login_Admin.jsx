...
export default function Login_Admin() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/auth/login/admin`, {
        method: 'POST',
            ...
            <div className="bg-white shadow-none rounded-none border-0">
              <div className="flex flex-wrap">
                ...
                <div className="w-full lg:w-1/2">
                  <img
                    src="https://demo.activeitzone.com/ecommerce_repo/public/uploads/all/2UA4vW1NAm5d7GHUmNdkW8Hrrd5NJEFSkBaEfPpg.webp"
                ...
                >
                  ...
                  <div className="text-center lg:text-left">
                    ...
                    >
                      Welcome to Active eCommerce CMS
                    </h1>
